...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"sendForm\": () => (/* binding */ sendForm)\n/* harmony export */ });\n/* harmony import */ var _validation__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./validation */ \"./js/modules/validation.js\");\n/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helpers */ \"./js/modules/helpers.js\");\n\r\n\r\n\r\nconst sendForm = () => {\r\n    const forms = document.querySelectorAll('form');\r\n    const url = 'https://jsonplaceholder.typicode.com/posts';\r\n\r\n    const loader = document.querySelector('.loader-box');\r\n\r\n    const succes = document.querySelector('.alert-success');\r\n    const danger = document.querySelector('.alert-danger');\r\n\r\n    forms.forEach(form => {\r\n        form.addEventListener('submit', e => {\r\n            e.preventDefault();\r\n\r\n            const inputs = form.querySelectorAll('input');\r\n\r\n            if ((0,_validation__WEBPACK_IMPORTED_MODULE_0__.validationSubmit)(inputs)) {\r\n                const formData = new FormData(form);\r\n                const data = {};\r\n\r\n                formData.forEach((value, key) => {\r\n                    data[key] = value;\r\n                });\r\n\r\n                form.reset();\r\n                loader.style.display = 'block';\r\n\r\n                fetch(url, {\r\n                    method: 'POST',\r\n                    body: JSON.stringify(data),\r\n                    headers: {\r\n                        'Content-type': 'application/json; charset=UTF-8',\r\n                    },\r\n                })\r\n                    .then(response => response.json())\r\n                    .then(() => {\r\n                        loader.style.display = '';\r\n\r\n                        _helpers__WEBPACK_IMPORTED_MODULE_1__.review.show(succes, '', 'flex');\r\n                        setTimeout(() => _helpers__WEBPACK_IMPORTED_MODULE_1__.review.hide(succes), 3000);\r\n                    })\r\n                    .catch(() => {\r\n                        loader.style.display = '';\r\n\r\n                        _helpers__WEBPACK_IMPORTED_MODULE_1__.review.show(danger, '', 'flex');\r\n                        setTimeout(() => _helpers__WEBPACK_IMPORTED_MODULE_1__.review.hide(danger), 3000);\r\n                    });\r\n            }\r\n        });\r\n    });\r\n};\r\n\n\n//# sourceURL=webpack://middle_diplom/./js/modules/sendForm.js?");
